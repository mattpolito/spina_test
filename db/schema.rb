...
ActiveRecord::Schema[7.0].define(version: 2022_08_11_205429) do
  ...
  create_table "spina_pro_not_found_errors", force: :cascade do |t|
    ...
    t.datetime "last_visited", precision: nil, null: false
  ...
  create_table "spina_pro_page_revisions", force: :cascade do |t|
    t.jsonb "content"
    t.jsonb "json_attributes"
    t.bigint "page_id"
    t.text "note"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["page_id"], name: "index_spina_pro_page_revisions_on_page_id"
  end

  create_table "spina_pro_search_documents", force: :cascade do |t|
    t.text "content"
    t.string "searchable_type"
    t.bigint "searchable_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["searchable_type", "searchable_id"], name: "index_spina_pro_search_documents_on_searchable"
  end
